          ...
          <ul class="space-y-2 font-medium">
            <li>
              ...
              >
                ...
                <span class="ms-3 text-[#637a5e]">Liked Songs</span>
              </a>
            </li>
            <li>
              <a
            ...
            <li>
              ...
              >
                ...
                <span class="flex-1 ms-3 text-[#637a5e] whitespace-nowrap">Artists</span>
              </a>
            </li>
            <li>
              <a
              ...
              >
                ...
                <span class="flex-1 ms-3 text-[#637a5e] whitespace-nowrap">New Release</span>
              </a>
            </li>
            <li>
              <a
              ...
              >
                ...
                <span class="flex-1 ms-3 text-[#637a5e] whitespace-nowrap">Sign In</span>
              </a>
            </li>
            <li>
              <a
              ...
              >
                ...
                <span class="flex-1 ms-3 text-[#637a5e] whitespace-nowrap">Sign Up</span>
              </a>
            </li>
          </ul>
        </div>
